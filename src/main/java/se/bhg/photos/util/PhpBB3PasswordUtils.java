...
public class PhpBB3PasswordUtils {
	/*
	 * Source
	 * http://larsho.blogspot.se/2008/02/passwords-in-phpbb-3.html
	 */
	...
	"./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
	  ...
	  private static String _hash_gensalt_private(
	  ...
	  public static boolean phpbb_check_hash(
